...
//alokasi Edge baru
adrEdge AlokasiEdge(adrKota nodeTujuan) {
    adrEdge edgeBaru = new ElmEdge;
    edgeBaru->kotaTujuan = nodeTujuan;
    edgeBaru->Next = NULL;
    return edgeBaru;
}

//Menambahkan Node ke dalam Graph
void InsertNode(Graph &G, string namaKota) {
...
adrKota FindNode(Graph G, string namaKota) {
    adrKota nodeBantu = G.First;
...
void ConnectNode(Graph &G, string namaKota1, string namaKota2, int jarak) {
    adrKota node1 = FindNode(G, namaKota1);
    adrKota node2 = FindNode(G, namaKota2);
    adrKota node3 = FindNode(G, jarak);
    ...
    if (node1 != NULL && node2 != NULL && node3 != NULL) {
        ...
        adrEdge Edge3 = AlokasiEdge(node2);
        Edge2->Next = node2->firstEdge;
        node3->firstEdge = Edge3;
    } else {
...
void PrintInfoGraph(Graph G) {
    ...
    while (nodeBantu != NULL) {
        ...
        while (edgeBantu != NULL) {
            cout << edgeBantu->kotaTujuan->namakota << " "; //Akses info dari node tujuan
            edgeBantu = edgeBantu->Next;
        }
        cout << endl;
        nodeBantu = nodeBantu->Next;
