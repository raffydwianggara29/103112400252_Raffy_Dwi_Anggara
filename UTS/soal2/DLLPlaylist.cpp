...
void insertFirst(linkedlist &List, string tittle, string Artist, int Duration, int Playcount, float rating){
    ...
    cout << "Node " << tittle << " berhasil ditambahkan sebagai node pertama list" << endl;
}
